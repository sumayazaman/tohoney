            ...
            <div class="row">
                <div class="col-lg-9 col-12">
                    <div class="blog-details-wrap">
                        <img src="{{ asset('tohoney/images/blog/blog-details.jpg') }}" alt="">
                            ...
                            <ol class="comments">
                                <li class="comment even thread-even depth-1">
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{ asset('tohoney/images/comment/1.png') }}" alt="Jhon">
                                            </div>
                                        </div>
                                    ...
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{ asset('tohoney/images/comment/2.png') }}" alt="Jhon">
                                            </div>
                                        </div>
                                        <div class="comment-main-area">
                                            <div class="comment-wrapper">
                                    ...
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{ asset('tohoney/images/comment/3.png') }}" alt="Jhon">
                                            </div>
                                        </div>
                                        <div class="comment-main-area">
                                            <div class="comment-wrapper">
                    ...
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_recent_entries recent_post">
                            ...
                            <ul>
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('tohoney/images/post/1.jpg') }}" alt="">
                                    </div>
                                ...
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('tohoney/images/post/2.jpg') }}" alt="">
                                    </div>
                                    <div class="post-content">
                                        <a href="blog-details.html">Lorem Ipsum is simply dummy text of the </a>
                                        <p>19 JAN 2019</p>
                                ...
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('tohoney/images/post/3.jpg') }}" alt="">
                                    </div>
                                    <div class="post-content">
                                        <a href="blog-details.html">Lorem Ipsum is simply dummy text of the </a>
                                        <p>19 JAN 2019</p>
                                ...
                                <li>
                                    <div class="post-img">
                                        <img src="{{ asset('tohoney/images/post/4.jpg') }}" alt="">
                                    </div>
                                    <div class="post-content">
                                        <a href="blog-details.html">Lorem Ipsum is simply dummy text of the </a>
                                        <p>19 JAN 2019</p>
